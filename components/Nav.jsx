              ...
              className="h-screen bg-green-500 top-0 fixed w-full">
                <div className="flex flex-col h-full w-full justify-between relative">
                  ...
                  <div className="px-6 pb-4 w-full justify-between flex items-center gap-2">
                    <Link href={'#'} className="h-12 w-12 twitterx">
                        <motion.svg 
                    ...
                    <Link href={'#'} className="h-12 w-12 instagram">
                        <motion.svg 
                        initial={{ y: 50, opacity: 0 }}
                        whileInView={{ y: 0, opacity: 1 }}
                    ...
                    <Link href={'#'} className="h-12 w-12 linkedin">
                        <motion.svg 
                        initial={{ y: 50, opacity: 0 }}
                        whileInView={{ y: 0, opacity: 1 }}
                    ...
                    <Link href={'#'} className="h-12 w-12 facebook">
                        <motion.svg 
                        initial={{ y: 50, opacity: 0 }}
                        whileInView={{ y: 0, opacity: 1 }}
                    ...
                    <Link href={'#'} className="h-12 w-12 github">
                        <motion.svg 
                        initial={{ y: 50, opacity: 0 }}
                        whileInView={{ y: 0, opacity: 1 }}
