...
// })
    ...
    return (
        <div className="w-full fixed z-30 top-0 overflow-hidden">
            ...
            {open && (
              ...
              animate="animate"
              exit="exit"
              className="newMenu bg-green-500 top-0 fixed w-full h-screen">
                ...
                <div className="flex flex-col h-full w-full justify-between">
                  ...
                  <div className="px-6 pb-4 w-full justify-between flex items-center gap-2">
                    <Link href={'https://twitter.com/OgbuaguGreat?t=AFnl3OEwVR2BFGPoTYaGYQ&s=09'} className="h-12 w-12 twitterx">
                        <motion.svg 
                    ...
                    <Link href={'https://www.instagram.com/dev.alex_dgreat/'} className="h-12 w-12 instagram">
                        <motion.svg 
                        initial={{ y: 50, opacity: 0 }}
                        whileInView={{ y: 0, opacity: 1 }}
                    ...
                    <Link href={'https://www.linkedin.com/in/great-alexander-713137232?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app'} className="h-12 w-12 linkedin">
                        <motion.svg 
                        initial={{ y: 50, opacity: 0 }}
                        whileInView={{ y: 0, opacity: 1 }}
                    ...
                    <Link href={'https://web.facebook.com/profile.php?id=100084571524832&_rdc=1&_rdr'} className="h-12 w-12 facebook">
                        <motion.svg 
                        initial={{ y: 50, opacity: 0 }}
                        whileInView={{ y: 0, opacity: 1 }}
                    ...
                    <Link href={'https://github.com/devalexdgreat'} className="h-12 w-12 github">
                        <motion.svg 
                        initial={{ y: 50, opacity: 0 }}
                        whileInView={{ y: 0, opacity: 1 }}
